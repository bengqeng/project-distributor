                    ...
                    <div class="col-lg-3 py-3 px-4">
                        <div class="card text-white">
                            ...
                            <div class="card-img-overlay h-100 d-flex flex-column justify-content-end">
                                <h5 class="card-title font-weight-bold text-center">{{ Str::limit($product->title, 20, $end='...') }}</h5>
                                <a class="align-self-center btn-sm btn-our-grey" href="{{ route('landingpage.product.detail', $product->slug) }}">View Product</a>
