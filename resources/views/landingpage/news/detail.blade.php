        ...
        <div class="row">
                ...
                <div class="p-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-1"><a class="text-our-white" href="!#"><i class="fab con fa-instagram"
                                    style="font-size:24px"></i></a></div>
                        <div class="col-1"><a class="text-our-white" href="http://twitter.com/share?text={!!$news->title!!} !!! &url={{ url()->current() }} &hashtags=hashtag1,hashtag2,hashtag3"><i class="fab con fa-twitter"
                                    style="font-size:24px"></i></a></div>
                    </div>
                </div>
            </div>
            <div class="col-6 py-3 px-0 aboutbg" id="rightcolumn">
                <div class="text-white p-5">
                    ...
                    <p class="card-text mb-3">Last updated {!! $news->updated_at !!}</p>
                    <p class="pb-3">
                        {!! $news->content !!}
                    </p>
                </div>
